  ...
  <div class="card-body" style="background-color:#DCE775;">
    <div class="container mb-5 mt-3" >
      <div class="row d-flex align-items-baseline" style="background-color:#00E676;">
        <div class="col-xl-9" >
          <p style="color: #7e8d9f;font-size: 20px;">Invoice >> <strong>ID: <?php echo e($patient->id); ?></strong></p>
        </div>
        <div class="col-xl-3 float-end">
          ...
          <a href="<?php echo e(url('invoice', $patient->id)); ?>" class="btn btn-light text-capitalize" data-mdb-ripple-color="dark"><i
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-8">
            <ul class="list-unstyled">
              <li class="text-muted">To: <span style="color:#5d9fc5 ;"><?php echo e($patient->Patient_Name); ?></span></li>
          ...
          <div class="col-xl-4">
            ...
            <ul class="list-unstyled">
              ...
              <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                  class="fw-bold">Creation Date: </span><?php echo e($patient->created_at); ?></li>
              <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
            ...
            <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $total += $details['price'] * $details['Quentity'] ?>
                    <tr>
                        ...
                        <td><?php echo e($details['Quentity']); ?></td>
                        <td>$<?php echo e($details['price'] * $details['Quentity']); ?></td>
                    </tr>
        ...
        <div class="row">
          ...
          <div class="col-xl-3">
            <ul class="list-unstyled">
              <li class="text-muted ms-3"><span class="text-black me-4">SubTotal</span> $<?php echo e($total); ?></li>
              <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Tax(15%)</span>$0</li>
            </ul>
            <p class="text-black float-start"><span class="text-black me-3"> Total Amount</span><span
                style="font-size: 25px;"> $<?php echo e($total); ?></span></p>
          </div>
        </div>
        <hr>
        <div class="row">
...
<?php /**PATH C:\xwamp\htdocs\laraval\Hospital-app\resources\views/famacy/invoice0.blade.php ENDPATH**/ ?>