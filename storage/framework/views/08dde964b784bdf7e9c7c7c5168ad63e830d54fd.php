...
<body>
    ...
    <div class="container">
        ...
        <div class="body-section">
            <div class="row">
                <div class="col-6">
                    <h2 class="heading">Invoice No.:<?php echo e($patient->id); ?></h2>
                    
                    <p class="sub-heading">Order Date: <?php echo e($patient->created_at); ?></p>
                    <p class="sub-heading">Email Address: customer@gfmail.com </p>
                </div>
                <div class="col-6">
                    <p class="sub-heading">Full Name: <?php echo e($patient->Patient_Name); ?> </p>
...
<?php /**PATH C:\xwamp\htdocs\laraval\Hospital-app\resources\views/famacy/invoice.blade.php ENDPATH**/ ?>