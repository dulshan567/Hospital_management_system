...
<body>
    ...
    <div>
        ...
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm">
            <div class="container">
            <a class="navbar-brand" href="#"><span class="text-danger">G+</span>&nbsp;<b>Hospital</b></a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <li class="nav-item">
                                    <a class="btn btn-success" type="button" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                                </li>
                            <?php endif; ?>
...
<?php /**PATH C:\xwamp\htdocs\laraval\Hospital-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>