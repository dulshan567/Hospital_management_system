            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <?php else: ?>
                        <li class="nav-item">
                        <a type="button" class="btn btn-danger"  href="<?php echo e(url('getappointment')); ?>"  >
                          Get Appointment &nbsp; </a> &nbsp;
                        </li>
                        <li class="nav-item">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card text-center border border-primary shadow-0" style="background-color:#f943a4;">
          <div class="card-body">
           ...
           <a type="button" class="btn btn-primary" href="<?php echo e(url('getappointment')); ?>">Click Here</a>
          </div>
        </div>
      </div>
    </div>
...
<?php /**PATH C:\xwamp\htdocs\laraval\Hospital-app\resources\views/apointhome.blade.php ENDPATH**/ ?>