  ...
  <!-- Back and log in -->
     ...
     Success Alert -->
                          <!-- <div class="alert alert-success alert-dismissible fade show">
                              <strong>Log In Success!</strong> <button type="button" class="btn btn-outline-danger"><b>Your Number Is : {{ Auth::user()->id }}</b> </button>
...
<div class="mySlides fade">
  ...
  <div class="page-hero bg-image " style="background-image: url(../assets/img/mainimg/1.jpg); ">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
...
<div class="mySlides fade">
  ...
  <div class="page-hero bg-image" style="background-image: url(../assets/img/mainimg/2.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <span class="subhead"></span>
        <h1 class="display-4"><Healthy Living/h1>
...
<div class="mySlides fade">
  ...
  <div class="page-hero bg-image " style="background-image: url(../assets/img/mainimg/3.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <span class="subhead"></span>
...
<div class="mySlides fade">
  ...
  <div class="page-hero bg-image" style="background-image: url(../assets/img/mainimg/4.jpg); background-size: cover; background-position: center;">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <span class="subhead"></span>
        <h1 class="display-4"></h1>
...
<section class="home-contact">
   ...
   <div class="content">
      <h3>have any questions...?</h3>
        <a href="{{url('Contact')}}" class="btn btn-outline-success">Contact us</a>
   </div>
