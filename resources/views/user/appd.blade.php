...
<!--/.Navbar-->
  ...
  <div class="card text-center border border-primary shadow-0 text-white" style="background-color:#0ccf7b;">
  <div class="card-body">
...
<div class="card text-center border border-primary shadow-0 text-white" style="background-color:#cf0c47;">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <button type="button" class="btn btn-primary">Button</button>
  </div>
...
<div class="card text-center border border-primary shadow-0 text-white" style="background-color:#cf0c20;">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <button type="button" class="btn btn-primary">Button</button>
  </div>
